...
- **진짜 그랜드 피아노 음색**: 실제 피아노 샘플(Salamander Grand Piano)을 음높이별로 재생 + 홀 리버브
- **연주형 메커닉**: 자동 반주 제거 — 키를 누를 때만 소리가 난다
- **잘못 눌러도 항상 듣기 좋게**: 어떤 입력이든 그 곡 조성에 맞는 음을 재생(가까운 노트 음/레인 대표음)

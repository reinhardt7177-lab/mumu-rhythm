...
export const songs: Song[] = [
  ...
  buildSong({
    ...
    mission: {
      eyebrow: "빠른 클래식 04",
      title: "연주자의 속도 변화와 숨을 들어요",
      description: "피아니스트가 가락을 길게 머물게 했다가 갑자기 빠르게 달립니다. 실제 연주의 느림과 빠름이 어떻게 바뀌는지 들어 보세요.",

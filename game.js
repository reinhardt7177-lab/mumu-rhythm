...
const nurserySongs = [
  ...
  },
  {
    ...
    difficulty: "보통",
    bpm: 112,
    image: "./assets/songs/london-bridge.png",
    lesson: "짧은 구절 반복",
    melody: ["G4", "A4", "G4", "F4", "E4", "F4", "G4", "D4", "E4", "F4", "E4", "F4", "G4"],
  },
  {
    id: "frere",
    title: "프레르 자크",
    difficulty: "쉬움",
    bpm: 100,
    image: "./assets/songs/frere-jacques.png",
    lesson: "같은 패턴 따라치기",
    melody: ["C4", "D4", "E4", "C4", "C4", "D4", "E4", "C4", "E4", "F4", "G4", "E4", "F4", "G4"],
  },
  {
    id: "sheep",
    title: "검은 양 바바",
    difficulty: "쉬움",
    bpm: 104,
    image: "./assets/songs/baa-sheep.png",
    lesson: "묻고 답하는 프레이즈",
    melody: ["G4", "E4", "D4", "C4", "D4", "E4", "G4", "G4", "A4", "G4", "E4", "D4", "C4", "D4", "E4", "C4"],
  },
  {
    id: "alphabet",
    title: "알파벳 멜로디",
    difficulty: "보통",
    bpm: 108,
    image: "./assets/songs/alphabet.png",
    lesson: "긴 문장 리듬 유지",
    melody: ["C4", "C4", "G4", "G4", "A4", "A4", "G4", "F4", "F4", "E4", "E4", "D4", "D4", "C4", "G4", "G4"],
  },
  {
    id: "arirang",
    title: "아리랑",
    difficulty: "보통",
    bpm: 88,
    image: "./assets/songs/arirang.png",
    lesson: "느린 박과 긴 호흡",
    melody: ["E4", "G4", "A4", "G4", "E4", "D4", "C4", "D4", "E4", "G4", "E4", "D4", "C4"],
  },
  {
    id: "boat",
    title: "작은 배 노래",
    difficulty: "쉬움",
    bpm: 92,
    image: "./assets/songs/row-boat.png",
    lesson: "부드러운 3박 흐름",
    melody: ["C4", "C4", "C4", "D4", "E4", "E4", "D4", "E4", "F4", "G4", "C5", "C5", "G4", "G4", "E4", "E4", "C4"],
  },
  {
    id: "forest",
    title: "숲속 소풍",
    difficulty: "어려움",
    bpm: 120,
    image: "./assets/songs/forest-picnic.png",
    lesson: "빠른 음 바꾸기",
